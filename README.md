...
### Сделал Пересторонин Максим Дмитриевич БПИ 217 Вариант 21 на оценку 6
<br>Из-за требования "необходимо представить только одну
...
ассемблере не нужно" многие ссылки введут в одно и то же место. Это связано с тем, что я хотел сохрнить привычную структуру отчета, где видно проделланую работу на каждый пункт того или иного балла.
## На 4 балла:
